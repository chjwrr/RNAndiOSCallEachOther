!function(root, factory) {
    ...
    return function(modules) {
            ...
            function detectReactBuildType(renderer) {
                try {
                    ...
                    if ("string" == typeof renderer.version) {
                        ...
                        return 0 !== findFiberCode.indexOf("function") ? "production" : /function[\s\w]*\(\w[,\)]/.test(findFiberCode) ? "production" : "development";
                    }
                    if (renderer.Mount && renderer.Mount._renderNewRootComponent) {
                        var renderRootCode = toString.call(renderer.Mount._renderNewRootComponent);
                        return 0 !== renderRootCode.indexOf("function") ? "production" : renderRootCode.indexOf("storedMeasure") !== -1 ? "development" : renderRootCode.indexOf("should be a pure function") !== -1 ? "development" : /function\s*\(\w\,/.test(renderRootCode) ? renderRootCode.indexOf("._registerComponent") !== -1 ? "outdated" : "production" : "development";
                    }
                } catch (err) {}
                return "production";
            }
        ...
        function getData(internalInstance) {
            ...
            "string" == typeof type ? (name = type, "number" == typeof internalInstance._domID && "function" == typeof internalInstance.getPublicInstance && (publicInstance = internalInstance.getPublicInstance())) : "function" == typeof type ? (nodeType = "Composite", 
